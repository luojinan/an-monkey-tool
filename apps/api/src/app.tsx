import { copyToClipboard } from "@an-monkey-tool/utils";
...
export function App() {
	...
	const getApiName = () => {
		...
		const filteredDivs = Array.from(allDivs).filter(
			(div) => div?.parentElement?.getAttribute("aria-hidden") === "false",
		);
	...
	return (
		<>
			<div className="toast toast-center">
				...
				>
					<span>
						🎉 copy success <em className="underline">{name}</em>
					</span>
				</div>
			</div>
		</>
