...
(t=>{if(typeof GM_addStyle=="function"){GM_addStyle(t);return}const e=document.createElement("style");e.textContent=t,document.head.append(e)})(" .tabs{margin:unset}.topic-reply .reply-content{margin-bottom:0}.pil{border-radius:50%}.topic-content .user-face{float:unset;display:flex;width:unset;height:unset}.topic-reply .user-face{width:36px;height:36px;margin-right:10px}.topic-reply .user-face .pil{width:36px;height:36px}.operation-div{display:none}.reply-quote{width:unset} ");
...
(function (preact) {
  ...
  const ToastContext = preact.createContext(void 0);
  const ToastProvider = ({ children }) => {
    const [toasts, setToasts] = p([]);
    ...
    return /* @__PURE__ */ u$1(ToastContext.Provider, { value: { showToast }, children: [
      /* @__PURE__ */ u$1("style", { children: styles }),
      children,
      toasts.map((toast, index) => /* @__PURE__ */ u$1("div", { className: "toast toast-center z-10", children: /* @__PURE__ */ u$1("div", { className: "alert alert-success text-white", children: /* @__PURE__ */ u$1("span", { children: toast.message }) }) }, index))
    ] });
  };
  const useToast = () => {
    const context = P(ToastContext);
    if (context === void 0) {
  ...
  const fixPhone = () => {
    ...
    const h3Element = topicDoc == null ? void 0 : topicDoc.querySelector("h3");
    const userFaceDiv = document.querySelector(".user-face");
    if (h3Element) {
      topicDoc == null ? void 0 : topicDoc.removeChild(h3Element);
      userFaceDiv == null ? void 0 : userFaceDiv.appendChild(h3Element);
    } else {
  ...
  function resetOutsideDoubanLink() {
  ...
  function extractRichTextContent(element) {
    let content = "";
    element.childNodes.forEach((node) => {
      if (node.nodeType === Node.TEXT_NODE) {
        ...
        if (tagName === "p") {
          content += "\n";
          content += extractRichTextContent(node);
        } else if (tagName === "img") {
          content += "";
        } else if (tagName === "a") {
  ...
  function App() {
    ...
    const [qaList, setQaList] = p([]);
    const [content, setContent] = p("");
    ...
    const menuList = [
      {
        ...
        onClick: () => {
          var _a, _b;
          const title = (_b = (_a = document.querySelector(".article h1")) == null ? void 0 : _a.textContent) == null ? void 0 : _b.trim();
          navigator.clipboard.writeText(`${title == null ? void 0 : title.replace("作业｜【作业】", "")}（${location.host}${location.pathname}）`);
          showToast("🎉 复制成功，去粘贴吧～");
        }
      },
      {
    ...
    const removeComment = () => {
      ...
      document.querySelectorAll(".reply-content").forEach((item) => {
        var _a, _b;
        const dom = item;
        let content2 = dom.innerText.replace(filterCommentText, "");
        ...
        if (!content2 || ["d", "D", "牛", "，", ",", "。", "马", "天才", "🐎", "码", "m", "滴", "顶顶"].includes(content2)) {
          ...
          dom.innerText = content2;
        }
      });
      return localCount;
    };
    const insertElementBeforeFirstRendered = (className, newElement) => {
    ...
    const replaceJdNum2Link = () => {
      ...
      if (contentDiv) {
        ...
        paragraphs.forEach(function(p2) {
          var regex = /\b10\d{10,}(?!\.html)\b/g;
          p2.innerHTML = p2.innerHTML.replace(regex, function(match) {
            return `${match}<a href="https://item.jd.com/${match}.html" target="_blank"> ✨京东链接</a>`;
          });
          Object.keys(sbCodeMap).forEach(function(key) {
            var _a, _b, _c;
            if (!((_a = p2.textContent) == null ? void 0 : _a.includes("http")) && !((_b = p2.textContent) == null ? void 0 : _b.includes(".com")) && ((_c = p2.textContent) == null ? void 0 : _c.includes(key))) {
              p2.textContent = p2.textContent.replace(new RegExp(key, "g"), `${key}(${sbCodeMap[key]})`);
            }
          });
        });
      }
...
${title == null ? void 0 : title.replace("作业｜【作业】", "")}${richTextContent}`;
        setContent(text);
      }
    };
    _(() => {
    ...
    return /* @__PURE__ */ u$1(preact.Fragment, { children: /* @__PURE__ */ u$1("div", { className: "drawer drawer-end", style: { "zIndex": 1 }, children: [
      /* @__PURE__ */ u$1("input", { id: "my-drawer", type: "checkbox", className: "drawer-toggle" }),
      /* @__PURE__ */ u$1("div", { className: "fixed right-2 bottom-5", children: /* @__PURE__ */ u$1("label", { htmlFor: "my-drawer", className: "btn btn-primary drawer-button", onClick: onBtn, children: [
        "✨ 已移除无效评论",
        count,
        "条"
      ] }) }),
      /* @__PURE__ */ u$1("div", { className: "drawer-side", children: [
        ...
        /* @__PURE__ */ u$1("ul", { className: "menu bg-base-200 text-base-content min-h-full w-4/5 p-4", children: [
          /* @__PURE__ */ u$1("div", { class: "card py-2 mb-4 shadow-md rounded-box whitespace-pre-wrap", children: content }),
          menuList.map((item) => /* @__PURE__ */ u$1("button", { className: "btn btn-primary w-full mb-2", onClick: item == null ? void 0 : item.onClick, children: item.title }, item.title))
        ] })
      ] })
    ] }) });
  }
