...
(t=>{if(typeof GM_addStyle=="function"){GM_addStyle(t);return}const e=document.createElement("style");e.textContent=t,document.head.append(e)})(" .tabs{margin:unset}.topic-reply .reply-content{margin-bottom:0}.pil{border-radius:50%}.topic-content .user-face{float:unset;display:flex;width:unset;height:unset}.topic-reply .user-face{width:36px;height:36px;margin-right:10px}.topic-reply .user-face .pil{width:36px;height:36px}.operation-div{display:none} ");
    ...
    const replaceJdNum2Link = () => {
      ...
      if (contentDiv) {
        ...
        paragraphs.forEach(function(p2) {
          ...
          Object.keys(sbCodeMap).forEach(function(key) {
            var _a, _b;
            if (!((_a = p2.textContent) == null ? void 0 : _a.includes("http")) && ((_b = p2.textContent) == null ? void 0 : _b.includes(key))) {
    ...
    return /* @__PURE__ */ u$1(preact.Fragment, { children: [
      ...
      /* @__PURE__ */ u$1("div", { className: "drawer drawer-end", style: { "zIndex": 1 }, children: [
        ...
        /* @__PURE__ */ u$1("div", { className: "drawer-side", children: [
          ...
          /* @__PURE__ */ u$1("ul", { className: "menu bg-base-200 text-base-content min-h-full w-4/5 p-4", children: menuList.map((item) => /* @__PURE__ */ u$1("button", { className: "btn btn-primary w-full mb-2", onClick: item == null ? void 0 : item.onClick, children: item.title }, item.title)) })
        ] })
      ] }),
