...
(t=>{if(typeof GM_addStyle=="function"){GM_addStyle(t);return}const e=document.createElement("style");e.textContent=t,document.head.append(e)})(" .tabs{margin:unset} ");
...
(function (preact) {
  ...
  const filterCommentText = /(d{2,})|谢谢姐妹|滴滴|谢谢|蹲|!|！|\s|(^[a-zA-Z]+$)|(^\d+$)/gi;
